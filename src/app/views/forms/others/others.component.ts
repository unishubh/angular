...
import { Promoter, Manufatureres, Sales } from '../../../services/models/vedndors';
          ...
          .subscribe(
            (data: any) => {
              ...
              if (this.formDataService.flago == 0) {
                this.formDataService.initOthers(rsp.salesData, rsp.manufacturersData, rsp.promotersData);
              }
